    ...
    render(){
        return(
            <form id="register_form">
                ...
                <div>
                    <label htmlFor='schoolIdentificationNumber'>School identification number </label>
                    <input
                        type='text'
                        name = 'schoolIdentificationNumber'
                        defaultValue = {this.props.schoolIdentificationNumber}
                        placeholder = 'Enter school identification number'
                ...
                <button type="button"
                            ...
                            onClick={this.props.onStudentSubmit}
                            id="reg_btn">
