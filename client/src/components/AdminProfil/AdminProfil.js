...
const AdminForm = lazy(() => import('../AdminForm/AdminForm'));
...
class AdminProfil extends Component {
    ...
    handleEdit = async (e) => {
        ...
        if(this.state.editedUser!==null) {
            ...
            const response = await fetch('http://localhost:8080/project/admin/'+this.props.loggedUser.id, {
                mode: 'cors',
                method: 'PUT',
